...
void main()
{
  char Name[30][40] = {"Sam Matthews", "Mary McBeth", "Ying Phakpon","Chai Chanchai", "Yong Boonsith", "Kitti Karndee", "Baraman Barabara"}; 
  int ID[30] = {5301, 5302, 5303, 5304, 5305, 5306, 5307}; 
